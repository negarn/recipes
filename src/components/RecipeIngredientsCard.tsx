...
export function RecipeIngredientsCard({
  ...
  return (
    <ContentPanelSection
      title="Ingredients"
      headerClassName="mb-3 grid gap-3 min-[720px]:mb-5 min-[720px]:flex min-[720px]:items-center min-[720px]:justify-between"
      titleWrapClassName="min-w-0"
      actions={
        <div className="flex w-full items-center justify-center whitespace-nowrap min-[720px]:ml-auto min-[720px]:w-auto min-[720px]:flex-none min-[720px]:justify-end">
          <ServingSizeControl
            value={servingCount}
    ...
    >
      ...
      <ul className="m-0 list-none p-0">
        {recipe.ingredients.map((ingredient) => (
          <li
            key={ingredient.id}
            className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-4 border-b border-app-field-border py-[0.9rem] last:border-b-0"
          >
